...
"""
    ...
    def test_lexeme_exists(self):
        ...
        self.assertFalse(derinet.lexeme_exists(Node(lex_id=1, pretty_id='3', lemma='Aabarův', morph='Aabarův_;S_^(*2)', pos='A', tag_mask='', parent_id=2, composition_parents=[], misc={}, children=[])))
        self.assertFalse(derinet.lexeme_exists(Node(lex_id=2, pretty_id='2', lemma='Aabarův', morph='Aabarův_;S_^(*2)', pos='A', tag_mask='', parent_id=2, composition_parents=[], misc={}, children=[])))
