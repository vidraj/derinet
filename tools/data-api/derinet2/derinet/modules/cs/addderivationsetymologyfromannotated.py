        ...
        with open(self.fname, 'rt') as annotated_data:
            for line in annotated_data:
                ...
                if annotation == "OK":
                    ...
                    # the derivation should be parent and parent should be its derivation
                    pass
                elif annotation == "COMPOUND":
                    # the derivation is compound
                    pass
                else:
                    # the parent isnt correct, there is a hand written correct parent
                    pass
        return Lexicon
