...
with open('log.txt','w') as logfile:
    ...
    for child in derinet._data:
        ...
        if child.pos=='N' and re.search(r'ák$', child.lemma):   #  POS ditete a pripona ditete
         
            parent_candidate_lemma = re.sub(r'ák',r'at',child.lemma) # hadani rodicovskeho lemmatu zamenou pripony
