...
with open('log.txt','w') as logfile:
    ...
    for child in derinet._data:
        ...
        if child.pos=='N' and re.search(r'tel$', child.lemma):   #  POS ditete a pripona ditete
         
            parent_candidate_lemma = re.sub(r'tel',r't',child.lemma) # hadani rodicovskeho lemmatu zamenou pripony
            parent_candidate_nodes = derinet.search_lexemes(parent_candidate_lemma,pos='V') # dejme tomu, ze rodic ma byt sloveso
