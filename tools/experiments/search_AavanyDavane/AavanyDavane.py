...
with open('log.txt','w') as logfile:
    ...
    for child in derinet._data:
        ...
        if child.pos=='D' and re.search(r'ávaně$', child.lemma):   #  POS ditete a pripona ditete
         
            parent_candidate_lemma = re.sub(r'ávaně',r'ávaný',child.lemma) # hadani rodicovskeho lemmatu zamenou pripony
